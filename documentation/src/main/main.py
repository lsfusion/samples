    ...
    tokens = {
        'root': [
            ...
            (words(('BOOLEAN', 'TBOOLEAN', 'BPISTRING', 'BPSTRING', 'COLOR', 'CSVFILE', 'CSVLINK', 'DATE', 'DATETIME',
                    ...
                    'APPLY', 'AS', 'ASK', 'ASON', 'ASYNCUPDATE', 'ATTACH', 'ATTR', 'AUTO', 'AUTOREFRESH', 'AUTOSET',
                    ...
                    'DATA', 'DB', 'DBF', 'DEFAULT', 'DEFAULTCOMPARE', 'DELAY', 'DELETE', 'DESC', 'DESIGN', 'DIALOG', 'DISABLE',
                    'DISABLEIF', 'DO', 'DOC', 'DOCKED', 'DOCX', 'DOWN', 'DRAW', 'DRILLDOWN', 'DROP', 'DROPCHANGED', 'DROPPED',
                    'ECHO', 'EDIT', 'ELSE', 'EMAIL', 'EMBEDDED', 'END', 'EQUAL', 'ESCAPE', 'EVAL', 'EVENTID', 'EVENTS',
                    ...
                    'INIT', 'INLINE', 'INPUT', 'INTERNAL', 'IS', 'JAVA', 'JOIN', 'JSON', 'JSONTEXT', 'KEYPRESS', 'LAST',
                    'LEFT', 'LIKE', 'LIMIT', 'LIST', 'LOCAL', 'LOCALASYNC', 'LOG', 'LOGGABLE', 'LSF', 'MANAGESESSION', 'MAP',
                    ...
                    'NESTEDSESSION', 'NEW', 'NEWCONNECTION', 'NEWEDIT', 'NEWEXECUTOR', 'NEWSESSION', 'NEWSQL', 'NEWTHREAD',
                    'NO', 'NOCANCEL', 'NOCHANGE', 'NOCOMPLEX', 'NOCONSTRAINTFILTER', 'NODEFAULT', 'NOENCODE', 'NOEXTID',
                    'NOESCAPE', 'NOFLEX', 'NOHEADER', 'NOHINT', 'NOINLINE', 'NOMANAGESESSION', 'NONULL', 'NOPREVIEW', 'NOREPLACE',
                    'NOSETTINGS', 'NOSTICKY', 'NOT', 'NOWAIT', 'NULL', 'OBJECT', 'OBJECTS', 'OK', 'ON', 'OPTIMISTICASYNC',
                    'OPTIONS', 'OR', 'ORDER', 'ORDERS', 'OVERRIDE', 'PAGESIZE', 'PANEL', 'PARAMS', 'PARENT', 'PARTITION',
                    'PASSWORD', 'PDF', 'PERIOD', 'PG', 'POPUP', 'PIVOT', 'POSITION', 'POST', 'PREREAD', 'PREV', 'PREVIEW',
                    'PRINT', 'PRIORITY', 'PROPERTIES', 'PROPERTY', 'PROPORTION', 'PUT', 'QUERYCLOSE', 'QUERYOK', 'QUICKFILTER',
                    'READ', 'READONLY', 'READONLYIF', 'RECALCULATE', 'RECURSION', 'REFLECTION', 'REGEXP', 'REMOVE', 'REPLACE',
                    'REPORT', 'REPORTFILES', 'REQUEST', 'REQUIRE', 'RESOLVE', 'RETURN', 'RGB', 'RIGHT', 'ROOT', 'ROUND',
                    'ROW', 'ROWS', 'RTF', 'SCHEDULE', 'SEEK', 'SELECTED', 'SELECTOR', 'SERIALIZABLE', 'SERVER', 'SET',
                    'SETCHANGED', 'SETDROPPED', 'SETTINGS', 'SHEET', 'SHOW', 'SHOWDEP', 'SHOWIF', 'SINGLE', 'SQL', 'START',
                    'STEP', 'STICKY', 'STRETCH', 'STRICT', 'STRONG', 'STRUCT', 'SUBJECT', 'SUBREPORT', 'SUCCESS', 'SUM',
                    ...
                    'TRY', 'TTRUE', 'UDP', 'UNGROUP', 'UP', 'USERFILTERS', 'VALIGN', 'VALUE', 'VERTICAL', 'VIEW', 'WAIT',
                    'WARN', 'WEAK', 'WHEN', 'WHERE', 'WHILE', 'WINDOW', 'WITHIN', 'WRITE', 'XLS', 'XLSX', 'XML', 'XOR',
                    'YES', 'YESNO', 'ZDATETIME'), prefix=r'\b', suffix=r'\b'),
             Keyword),
            (r".", Text),
        ]
    }
