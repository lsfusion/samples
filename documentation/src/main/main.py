    ...
    tokens = {
        'root': [
            ...
            (words(('BOOLEAN', 'TBOOLEAN', 'BPISTRING', 'BPSTRING', 'COLOR', 'CSVFILE', 'CSVLINK', 'DATE', 'DATETIME',
                    ...
                    'NOCANCEL', 'NOCHANGE', 'NOCOMPLEX', 'NOCONSTRAINTFILTER', 'NODEFAULT', 'NOENCODE', 'NOEXTID', 'NOESCAPE', 'NOFLEX',
                    ...
                    'ROWS', 'RTF', 'SCHEDULE', 'SEEK', 'SELECTED', 'SELECTOR', 'SERIALIZABLE', 'SERVER', 'SET',
                    'SETCHANGED', 'SETDROPPED', 'SETTINGS', 'SHEET', 'SHOW', 'SHOWDEP', 'SHOWIF', 'SINGLE',
