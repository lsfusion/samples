    ...
    tokens = {
        'root': [
            ...
            (words(('BOOLEAN', 'TBOOLEAN', 'BPISTRING', 'BPSTRING', 'COLOR', 'CSVFILE', 'CSVLINK', 'DATE', 'DATETIME',
                    ...
                    'COLUMN', 'COLUMNS', 'COMPLEX', 'CONCAT', 'CONFIRM', 'CONNECTION', 'CONSTRAINT', 'CONSTRAINTFILTER',
                    ...
                    'FILTER', 'FILTERGROUP', 'FILTERGROUPS', 'FILTERS', 'FINALLY', 'FIRST', 'FIXED', 'FLEX', 'FLOAT',
                    ...
                    'NOHEADER', 'NOHINT', 'NOINLINE', 'NOMANAGESESSION', 'NONULL', 'NOPREVIEW', 'NOSETTINGS', 'NOT',
                    'NOWAIT', 'NULL', 'OBJECT', 'OBJECTS', 'OK', 'ON', 'OPTIMISTICASYNC', 'OR', 'ORDER', 'ORDERS',
                    ...
                    'TRY', 'TTRUE', 'UNGROUP', 'UP', 'USERFILTER', 'VALIGN', 'VALUE', 'VERTICAL', 'VIEW', 'WAIT',
