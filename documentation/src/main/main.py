    ...
    tokens = {
        'root': [
            ...
            (words(('INTEGER', 'DOUBLE', 'LONG', 'BOOLEAN', 'DATE', 'DATETIME', 'TEXT', 'STRING', 'ISTRING', 'VARISTRING', 'VARSTRING', 'TIME', 'RICHTEXT',
                    ...
                    'CONTAINERH', 'CONTAINERV', 'CONTEXTMENU', 'CSV', 'CUSTOM', 'FILE', 'LINK', 'CYCLES', 'DATA', 'DBF', 'DEFAULT', 'DEFAULTCOMPARE', 'DELAY', 'DELETE',
                    ...
                    'FORM', 'FORMS', 'FORMULA', 'FROM', 'FULL', 'GOAFTER', 'GRID', 'GROUP', 'GROUPCHANGE', 'HALIGN', 'HEADER',
                    ...
                    'SUM', 'TAB', 'TABBED', 'TABLE', 'TEXTHALIGN', 'TEXTVALIGN', 'THEN', 'THREADS', 'THROW', 'TIME', 'TO', 'TODRAW',
