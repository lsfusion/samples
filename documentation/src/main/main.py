    ...
    tokens = {
        'root': [
            ...
            (words(('BOOLEAN', 'TBOOLEAN', 'BPISTRING', 'BPSTRING', 'COLOR', 'CSVFILE', 'CSVLINK', 'DATE', 'DATETIME',
                    ...
                    'CONTAINER', 'CONTAINERH', 'CONTAINERV', 'CONTEXTMENU', 'COOKIES', 'COOKIESTO', 'CSV', 'CUSTOM', 'CYCLES',
                    ...
                    'LIKE', 'LIMIT', 'LIST', 'LOCAL', 'LOCALASYNC', 'LOG', 'LOGGABLE', 'LSF', 'MANAGESESSION', 'MAP',
                    ...
                    'NOCANCEL', 'NOCHANGE', 'NOCOMPLEX', 'NOCONSTRAINTFILTER', 'NODEFAULT', 'NOEXTID', 'NOESCAPE', 'NOFLEX',
                    'NOHEADER', 'NOHINT', 'NOINLINE', 'NOMANAGESESSION', 'NONULL', 'NOPREVIEW', 'NOSETTINGS', 'NOSTICKY',
                    'NOT', 'NOWAIT', 'NULL', 'OBJECT', 'OBJECTS', 'OK', 'ON', 'OPTIMISTICASYNC', 'OPTIONS', 'OR', 'ORDER',
                    'ORDERS', 'OVERRIDE', 'PAGESIZE', 'PANEL', 'PARAMS', 'PARENT', 'PARTITION', 'PASSWORD', 'PDF', 'PERIOD',
                    'PG', 'POPUP', 'PIVOT', 'POSITION', 'POST', 'PREREAD', 'PREV', 'PREVIEW', 'PRINT', 'PRIORITY', 'PROPERTIES',
                    ...
                    'ROWS', 'RTF', 'SCHEDULE', 'SCROLL', 'SEEK', 'SELECTED', 'SELECTOR', 'SERIALIZABLE', 'SERVER', 'SET',
                    'SETCHANGED', 'SETDROPPED', 'SETTINGS', 'SHEET', 'SHOW', 'SHOWDEP', 'SHOWIF', 'SINGLE', 'SPLITH',
