    ...
    tokens = {
        'root': [
            ...
            (words(('INTEGER', 'DOUBLE', 'LONG', 'BOOLEAN', 'DATE', 'DATETIME', 'TEXT', 'STRING', 'ISTRING', 'VARISTRING', 'VARSTRING', 'TIME', 'RICHTEXT',
                    ...
                    'CONTAINERH', 'CONTAINERV', 'CSV', 'CUSTOM', 'CUSTOMFILE', 'CUSTOMLINK', 'CYCLES', 'DATA', 'DBF', 'DEFAULT', 'DEFAULTCOMPARE', 'DELAY', 'DELETE',
                    'DESC', 'DESIGN', 'DIALOG', 'DO', 'DOC', 'DOCKED', 'DOCX', 'DRAWROOT',
                    ...
                    'FILTERS', 'FINALLY', 'FIRST', 'FIXED', 'FIXEDCHARWIDTH', FOLDER', 'FOOTER', 'FOR', 'FORCE', 'FOREGROUND',
                    'FORM', 'FORMS', 'FORMULA', 'FROM', 'FULL', 'GOAFTER', 'GRID', 'GROUP', 'GROUPCHANGE', 'HALIGN', 'HEADER', 'HEADERS',
                    'HIDE', 'HIDESCROLLBARS', 'HIDETITLE', 'HINTNOUPDATE', 'HINTTABLE', 'HORIZONTAL',
                    'HTML', 'HTTP', 'IF', 'IMAGE', 'IMAGEFILE', 'IMAGELINK', 'IMPORT', 'IMPOSSIBLE', 'IN', 'INDEX',
                    'INDEXED', 'INIT', 'INITFILTER', 'INLINE', 'INPUT', 'IS', 'JAVA', 'JOIN', 'JSON', 'KEYPRESS', 'LAST', 'LEFT', 'LIKE', 'LIMIT',
                    ...
                    'ROUND', 'RTF', 'SCHEDULE', 'SCROLL', 'SEEK', 'SELECTOR', 'SESSION', 'SET', 'SETCHANGED', 'SHORTCUT', 'SHOW',
